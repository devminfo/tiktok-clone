...
<template>
  <div class="pt-[90px] 2xl:pl-[185px] lg:pl-[160px] lg:pr-2 w-[calc(100%-90px)] max-w-[1800px] 2xl:mx-auto">
    ...
    <div class="mt-4 grid 2xl:grid-cols-6 xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-2 grid-cols-2 gap-3">
      <PostUser post="post" />
    </div>
  </div>
</template>
