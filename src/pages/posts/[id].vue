...
watch(() => isLoaded.value, () => {
  if (isLoaded.value) setTimeout(() => video.value?.play(), 500)
})
</script>
...
<template>
  <div id="PostPage"
    ...
    <div class="lg:w-[calc(100%-540px)] h-full relative">
      <NuxtLink class="lg:w-[calc(100%-540px)] h-full relative">
      ...
      <img src="~/assets/images/tiktok-logo-small.png"
        class="absolute top-[18px] left-[70px] rounded-full lg:mx-0 mx-auto" width="45" />


      <video v-if="true" src="/video/4.mp4" class="absolute object-cover w-full my-auto z-[-1] h-screen"></video>
      ...
      <div class="bg-black bg-opacity-70 lg:min-w-[480px]">
        <video v-if="true" ref="video" loop muted src="/video/4.mp4" class="h-screen mx-auto"></video>
      </div>
    </div>
    ...
    <div id="InfoSection" v-if="true" class="lg:max-w-[550px] relative w-full h-full bg-white">
      ...
      <div class="flex items-center justify-between px-8">
        <div class="flex items-center">
          <NuxtLink href="/"><img src="http://picsum.photos/id/8/300/320" width="40" class="rounded-full lg:mx-0 mx-auto"
              alt=""></NuxtLink>
      ...
      <div id="Comments" class="bg-[#F8F8F8] z-0 w-full h-[calc(100%-273px)] border-t-2 overflow-auto">
        ...
        <div v-else class="flex items-center justify-between px-8 pt-4">
          <div class="flex items-center relative w-full">
            <NuxtLink to="/">
              <img src="https://picsum.photos/id/8/300/320" width="40"
            ...
            <div class="ml-14 pt-0.5 w-full">
              ...
              <div class="text-[15px] font-light">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolor qui consequuntur mollitia dolorem saepe
                laudantium impedit voluptate quibusdam? Rem, sed.
              </div>
            </div>
          </div>
        ...
        <div id="CreateComment" v-if="true"
          ...
          <button :disabled="!comment" @click="addComment"
            ...
            class="font-semibold text-ms ml-5 pr-1">Post</button>
