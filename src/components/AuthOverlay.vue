  ...
  <div id="AuthOverlay"
    ...
    <div class="relative bg-white w-full max-w-[470px] h-[70%] p-4 rounded-lg">
      <div class="w-full flex justify-end">
        <button @click="generalStore.closeLogin" class="p-1.5 rounded-full bg-gray-100">
      ...
      <div class="absolute flex items-center justify-center py-5 left-0 bottom-0 border-l w-full">
