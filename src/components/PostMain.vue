    ...
    <div class="pl-3 w-full px-4">
      <div class="flex items-center justify-between pb-0.5">
        <button>
          ...
          <span class="text-[13px] text-gray-500 pl-1 cursor-pointer">
            User name
          </span>
        </button>

        <button class="border text-[15px] px-[21px] py-0.5 border-[#F02C56] text-[#F02C56] font-bold rounded-md ">
          Follow
        </button>
      </div>
      ...
      <div class="mt-2.5 flex">
        <div
          class="relative min-h-[480px] max-h-[580px] max-w-[260px] flex items-center bg-black rounded-xl cursor-ponter">
          <video ref="video" loop muted class="rounded-xl object-cover mx-auto h-full" src="/4.mp4"></video>

          <img class="absolute right-2 bottom-14" width="90" src="~/assets/images/tiktok-log-white.png" alt="">
        </div>
